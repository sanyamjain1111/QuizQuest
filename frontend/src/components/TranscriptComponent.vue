  ...
  <div class="scores-container">
    ...
    <div class="navigation-footer">
      <div class="nav-buttons">
        <router-link to="/admindashboard" class="nav-button home-button">
          <span class="material-icons">home</span>
          Back to Home
        </router-link>
        
        <router-link to="/admin/student/academic" class="nav-button live-button">
  ...
  methods: {
    async fetchScores() {
      try {
        ...
        const response = await api.getQuizTranscript(quizId, uid);
